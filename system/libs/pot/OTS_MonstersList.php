 ...
 */
    public function __construct($path)
    {
		...
		$monstersFile = $this->monstersPath . 'monsters.xml';
        if (!file_exists($monstersFile)) {
            ...
            throw new Exception('Error: Cannot load monsters.xml. File not found at ' . $monstersFile);
        }
